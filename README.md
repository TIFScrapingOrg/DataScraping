<div>
  <img src="images/project_logo.png" height="200" alt="Logo">
</div>
...
## Getting Started
#### Prerequisites
- List of technologies, libraries, or tools required to run the project are within the text file requirements.txt (INSERT LINK).
